...
<head>
    ...
    <title>Barista Notifications | Chip3Chip</title>
...
<body class="bg-soft text-gray-800">
    ...
    <main class="p-8 md:ml-64 min-h-screen">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-gray-500 mt-1">Click on any row to view notification details</p>
            </div>
                    ...
                    <c:choose>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex justify-between items-start mb-1">
                                            ...
                                            <h3 class="font-bold text-gray-800 group-hover:text-primary transition-colors">
                                                Notification #${noti.notificationID}
                                            </h3>
                        ...
                        <c:otherwise>
                            <div class="py-20 flex flex-col items-center justify-center opacity-30">
                                ...
                                <p class="mt-4 font-bold">Empty Inbox</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
    ...
    <script>
        function openNotification(id, content, date) {
            ...
            document.getElementById('mDate').innerText = "send date " + date;
